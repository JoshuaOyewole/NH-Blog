    ...
    return (
        <React.Fragment>
            ...
            <div className="bg-townhall-background font-worksans -mt-5 h-full">
                <header className="mt-0 mx-auto mb-16">
                    <BlogNavbar />
                </header>

                <div className={`flex flex-col lg:flex-row gap-x-10 w-full lg:w-4/5 mx-auto px-4 lg:px-8 ${sans.className} mb-20`}>
                    <main className='basis-4/5 '>
                        <h1 className='text-2xl font-semibold lg:text-[2.1875rem] text-[#41505f] lg:font-medium leading-[2.5rem] lg:leading-[2.9rem]'>{title}</h1>
                        <div className="flex gap-x-2 lg:gap-x-4 mt-4 text-[#505050] font-[0.8125rem]">
                            <span className="flex">
                        ...
                        <div className="article_img h-[20rem] lg:h-[25rem] my-5 bg-cover bg-center rounded-xl" style={{ backgroundImage: `url(${blog_media[0]?.thumbnail})` }}>
                            {/*  <Image src={blog_media[0].thumbnail} alt={title} className='w-full h-[25rem] rounded-lg bg-center' width={200} height={100} /> */}
                        </div>
                        <div dangerouslySetInnerHTML={{ __html: blog_body }} className='mt-10 lg:text-lg !leading-[2.4rem] text-[#41505f]' />

                        <Card className='bg-white py-3 lg:py-6 rounded-lg px-4 lg:px-8 mt-20 flex gap-x-4 items-center border border-solid border-[#ebebf3]'>
                            <Box as='div' >
                            ...
                            <div className="author-info flex flex-col basis-[70%]">
                                <h3 className='text-[1.25rem] font-semibold min-[414px]:font-medium min-[414px]:text-2xl text-[#41505f] mb-2 '>{postedby_name}</h3>
                                <Text className='text-[#41505f] text-sm'>{posted_by_about}</Text>
                            </div>
